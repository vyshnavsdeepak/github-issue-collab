...
import { handleConnect, handleConnectCallback, handleDashboard, handleDashboardLogin, handleDashboardCallback, handleDashboardLogout, handleCreateInvite, handleRevokeSession, handleInviteHealth } from './connect'
...
app.get('/api/invite/health', (req, res) => {
  void handleInviteHealth(req, res)
})
